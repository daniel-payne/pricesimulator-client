...
import { ScenarioSpeed } from "./types/enums/ScenarioSpeed"
...
export class PriceSimulatorDexie extends Dexie {
  ...
  private scenarioCache: Record<string, Scenario | undefined> = {}
  private marketCache: Record<string, Market | undefined> = {}
  private trendCache: Record<string, Trend | undefined> = {}

  private indexCache: Record<string, number | undefined> = {}
  ...
  public async priceForSymbolAndDay(symbol: string, day: string) {
    ...
    let trend = await this.trendForSymbol(symbol)
