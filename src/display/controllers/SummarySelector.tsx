...
const TOOLTIP = "Show Summary"

export default function SummarySelector({ name = "SummarySelector", ...rest }: PropsWithChildren<ComponentProps>) {
  const [view, setView] = useQueryState<boolean>("show-summary", false)
